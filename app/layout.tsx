    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: "Custom website for local contractors. Live in 1–2 business days.",
        },
        price: "1000",
        priceCurrency: "USD",
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "Pro Website",
          description: "Custom website with custom domain, video hero, monthly updates, and ongoing SEO maintenance.",
        },
        price: "1000",
        priceCurrency: "USD",
        priceSpecification: {
